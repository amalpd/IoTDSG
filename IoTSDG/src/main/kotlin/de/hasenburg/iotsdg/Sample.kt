...
private const val minTravelDistance = 1.0
private const val maxTravelDistance = 20.0
        ...
        for (pub in 0..broker.third.second) {
            ...
            * not important */
            ...
            while (timestamp <= a.timeToRunPerClient) {
                ...
                if (a.getTrueWithChance(mobilityProbability)) {
                    location = a.calculateNextLocation(broker.second,
                            location,
